...
# ---------------------------------------------------------------------------
FACE_EMBED_PROVIDER = os.getenv("FACE_EMBED_PROVIDER", "mock")  # "mock" | "opencv"
...
FACE_MATCH_FRAMES_PER_SCENE = int(os.getenv("FACE_MATCH_FRAMES_PER_SCENE", "5"))  # 장면당 얼굴 검출 표본 프레임 수
FACE_MODEL_DIR = os.getenv("FACE_MODEL_DIR", "models/face")  # YuNet/SFace ONNX 모델 저장 경로
